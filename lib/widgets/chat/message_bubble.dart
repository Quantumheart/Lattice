...
class _HoverActionBar extends StatefulWidget {
  ...
  @override
  State<_HoverActionBar> createState() => _HoverActionBarState();
}

class _HoverActionBarState extends State<_HoverActionBar> {
